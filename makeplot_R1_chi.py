...
#ax3.plot(dataall[:, 0, 0], 1. * chi2_use,color = 'black' ,linewidth = 2) # feh  
ax3.plot(dataall[:, 0, 0], 1. * chisqs,color = 'black' ,linewidth = 2) # feh  
...
#ax3.set_ylim(-10000 ,4000000) 
ax3.set_ylim(np.array([0.01, 10.]) * 5. * median(chisqs)) 
...
ax3.text(l1a-19, 1000000.0, "chi2  " , fontsize = 12) 
...
ax3.set_ylabel("chi-squared", fontsize = 20) 
