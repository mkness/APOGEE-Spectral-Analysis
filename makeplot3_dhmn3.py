...
ax1.vlines(15958.8, -1,2, linestyle = 'dashed', linewidth = 2) 
ax2.vlines(15958.8, -1,2, linestyle = 'dashed', linewidth = 2) 
ax3.vlines(15958.8, -1,2, linestyle = 'dashed', linewidth = 2) 
ax4.vlines(15958.8, -1,2, linestyle = 'dashed', linewidth = 2) 
ax5.vlines(15958.8, -1,2, linestyle = 'dashed', linewidth = 2) 
...
ax1.text(l1c-9, 1.1, "mean spectra" , fontsize = 12) 
ax2.text(l1c-9, 0.0005, "Teff coeff" , fontsize = 12) 
ax3.text(l1c-9, 0.3, "log g coeff" , fontsize = 12) 
ax4.text(l1c-9, 0.3, "[Fe/H]  coeff" , fontsize = 12) 
ax5.text(l1c-9, 0.3, "[Fe/H]  coeff, log g coeff, Teff coeff*1000" , fontsize = 12) 
